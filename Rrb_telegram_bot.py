...
QUESTIONS = [
    {"q": "Speed of 180m train passing pole in 12s?", "opts": ["54 km/h","45 km/h","60 km/h","72 km/h"], "ans": 0, "exp": "15 m/s × 18/5 = 54 km/h"},
    ...
    {"q": "Battle of Plassey was fought in?", "opts": ["1764","1857","1757","1761"], "ans": 2, "exp": "1757"},
    {"q": "Series: 3, 9, 27, 81, ?", "opts": ["162","200","243","270"], "ans": 2, "exp": "×3 = 243"},
]
idx = [0]

async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    kb = [[InlineKeyboardButton("▶ Quiz শুরু করো", callback_data="quiz")]]
    await update.message.reply_text("🚂 RRB Test Bot-এ স্বাগতম!\n\n/quiz লিখে quiz শুরু করো!", reply_markup=InlineKeyboardMarkup(kb))
